    ...
    e.widget("blueimp.fileupload", e.blueimp.fileupload, {
        ...
        _processFile: function(s, r) {
            var i = this
              ...
              , t = o.promise();
            return this._trigger("process", null, s),
            e.each(s.processQueue, function(s, o) {
                var n = function(s) {
                    return r.errorThrown ? e.Deferred().rejectWith(i, [r]).promise() : i.processActions[o.action].call(i, s, o)
                };
        ...
        _transformProcessQueue: function(s) {
            ...
            e.each(s.processQueue, function() {
                ...
                e.each(this, function(r, o) {
                    i[r] = "string" === e.type(o) && "@" === o.charAt(0) ? s[o.slice(1) || (t ? t + r.charAt(0).toUpperCase() + r.slice(1) : r)] : o
                }),
                r.push(i)
            }),
            s.processQueue = r
        ...
        process: function(s) {
            ...
            return i.processQueue && i.processQueue.length && (this._transformProcessQueue(i),
            0 === this._processing && this._trigger("processstart"),
            e.each(s.files, function(o) {
                var t = o ? e.extend({}, i) : i
                  , n = function() {
                    return s.errorThrown ? e.Deferred().rejectWith(r, [s]).promise() : r._processFile(t, s)
                };
                t.index = o,
                r._processing += 1,
                r._processingQueue = r._processingQueue.pipe(n, n).always(function() {
                    r._processing -= 1,
